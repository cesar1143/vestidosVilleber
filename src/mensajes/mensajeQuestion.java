...
public static JFrame framePrincipal=new JFrame();
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(99, 154, 229));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensajeQuestion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensajeQuestion().setVisible(true);
            }
        });
    }
